...
const sven = {
  ...
  days: [1, 2],
  dayLinkFunc: (day) =>
    `https://github.com/STollenaar/AdventOfCode/blob/main/2025/day${day}/main.go`,
  language: "golang",
};
...
const natalie = {
  ...
  link: "https://github.com/ncashin/aoc",
  days: [1],
  dayLinkFunc: (day) => {
    if (day === 1) {
      return "https://github.com/ncashin/Advent-Of-Code/blob/main/2025/day1.rb";
    }
    return `https://github.com/ncashin/aoc/blob/main/2025/day${day}.exs`;
  },
  language: "elixir",
};
