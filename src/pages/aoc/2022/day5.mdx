...
> 
> yes! the core of iterative tools in rust is the [`Iterator`](https://doc.rust-lang.org/std/primitive.str.html#method.split) & [itertools](https://docs.rs/itertools/0.10.5/itertools/index.html#), and things built for / around it.
